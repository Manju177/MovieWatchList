  ...
  const movie=AllMovies.find((movie)=>movie.Title===id)
    ...
    <Layout>
         <div className='container mx-auto bg-dry py-0 px-2 mb-12'>
            <div className='flex-rows flex items-center gap-3 text-white py-3 px-8 rounded font-semibold border-2 border-red-600 bg-red-900 '>
            ...
            </div>
          {
            play?<video controls className='w-full h-full rounded'>
              <source src='/images/movie.mp4' type="video/mp4" title={movie?.Title}/>
            </video>:(
              <div className='w-full h-screen rounded-lg outline-pink-900 overflow-hidden relative'>
                <div className='absolute flex justify-center items-center top-0 left-0 bottom-0 right-0 bg-black-600 bg-opacity-30 flex flex-col'>
